  ...
  return (
    <AnimatePresence mode='wait'>
      ...
      >
        ...
        />
        <motion.div
          className='fixed m-auto top-0 bottom-0 left-0 right-0 text-white text-2xl md:text-8xl cursor-default z-50 w-fit h-fit'
          initial={{ opacity: 1 }}
          animate={{
            opacity: 0,
            transitionEnd: {
        ...
        <main className='h-[calc(100vh-4rem)] lg:h-[calc(100vh-5rem)] overflow-scroll'>
          {children}
        </main>
      </div>
    </AnimatePresence>
